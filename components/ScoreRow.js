...
export default class ScoreRow extends React.Component {
  ...
  render() {
    const { imageTeam1, imageTeam2,nameTeam1,nameTeam2,scoreTeam1,scoreTeam2} = this.props;
    return (
    <View style={styles.container}>
        ...
        <Text style={{color:Colors.purpleSoftTheme}}>{scoreTeam1}</Text>
        <Text style={{color:Colors.tintColor}}>VS</Text>
        <Text style={{color:Colors.purpleSoftTheme}} >{scoreTeam2}</Text>
        <Text style={styles.text}>
          {`${nameTeam2}`}
        </Text>
